...
%     else 
        %CoefMatrix = mexOMPerrIterative(Data, [FixedDictionaryElement,Dictionary],param.errorGoal);
         CoefMatrix  = full(mexOMP((Data), [FixedDictionaryElement,Dictionary], param));
       % param.L = 1;
%     end
...
%     figure,
%      I = displayDictionaryElementsAsImage(Dictionary, floor(sqrt(param.K)), floor(size(Dictionary,2)/floor(sqrt(param.K))),param.bb,param.bb,0);
